...
// 부서 커스터마이징: 정규화·프롬프트 블록은 부작용 없는 별도 모듈에 두고 fixture 테스트로 고정한다
// (board-custom.js·server.py 사본과 문구·규칙 동일). dept-prompt.test.ts 가 이 모듈을 핀한다.
import { deptPromptBlock } from './dept-prompt.ts';
